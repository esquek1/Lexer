...
public class Token {
    ...
    public Token() {
        ...
        tokens.put(33, List.of(":"));
        tokens.put(34, List.of("integer"));
        tokens.put(35, List.of("number"));
        tokens.put(36, List.of("text"));
        tokens.put(37, List.of("boolean"));
        tokens.put(38, List.of("use"));
        tokens.put(39, List.of("not", "Not"));
        tokens.put(40, List.of("not=", "Not="));
        tokens.put(41, List.of("."));
        tokens.put(42, List.of(","));
        tokens.put(43, List.of("="));
        tokens.put(44, List.of(">"));
        ...
        tokens.put(52, List.of("mod"));
        tokens.put(53, List.of("["));
        tokens.put(54, List.of("]"));
        tokens.put(55, List.of("("));
        tokens.put(56, List.of(")"));
        tokens.put(57, List.of("--"));
        tokens.put(58, List.of("if"));
        tokens.put(59, List.of("end"));
        tokens.put(60, List.of("class"));
        tokens.put(61, List.of("true", "false"));
